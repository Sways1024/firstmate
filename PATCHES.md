...
`patched` = upstream HEAD `833a9a2` (2026-08-07) plus twenty-nine fixes on eleven branches:
...
| `fm/fm-evidence-rule` | captain policy addition, no upstream issue | `AGENTS.md` hard rule 5 now also forbids stating as fact anything not verified in the current session, requiring it be labelled an assumption with what would confirm it. |
